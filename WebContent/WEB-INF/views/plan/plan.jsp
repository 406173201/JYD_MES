...
<title>计划管理</title>
	...
	<%@ include file="/template/plan/planListTemplate.jsp"%>
...
<body class="no-skin" youdao="bind" style="background: white">
	...
	<div class="page-header">
		<h1>
			计划管理 <small><i class="ace-icon fa fa-angle-double-right"></i>
				启动与修改 </small>
		</h1>
	</div>
					...
					<div id="dynamic-table_wrapper"
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="dataTables_length" id="dynamic-table_length">
									<label> 展示 <select id="pageSize"
										...
										aria-controls="dynamic-table"> <input type="hidden"
										value="0" name="search_status" id="search_status" />
									<!--  <label>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;是否启用 <select
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="dataTables_length" id="dynamic-table_length">
										<input id="startTime" type="search" name="startTime"
											class="form-control input-sm datepicker2" placeholder="开始时间"
											aria-controls="dynamic-table"> ~ <input id="endTime"
											type="search" name="endTime"
											class="form-control input-sm datepicker2" placeholder="结束时间"
											aria-controls="dynamic-table">
										&nbsp;&nbsp;&nbsp;&nbsp;
